 ...
 */
public class MyWantReturn {

    public static void main(String[] args) throws Exception {
        MyTList list = new MyTList();
        Thread c = new Thread(new MyC(list));
        Thread p = new Thread(new MyP(list));
        c.start();
        p.start();
    }

    static class MyC implements Runnable {
        private MyTList list;
        public MyC(MyTList list){
            this.list = list;
        }
    ...
    static class MyP implements Runnable {
        private MyTList list;
        public MyP(MyTList list){
            this.list = list;
        }
